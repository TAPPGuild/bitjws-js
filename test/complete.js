...
describe('Complete Test', function() {
    ...
    it("should return a string private key address", function() {
        var priv = bitws.wifToPriv("L3Ygumw9tv8Y7nP8y3cM164pMYugne5B9SPdf6jix1Rve4e91yTd");
        expect(priv.key).to.be.equal("bcc993177bec48f94cb0e617980a320f028f8cfa0f7a914d44ec84e017dc7cc6");
    });
...
describe('Complete Test on .min file', function() {
    ...
    it("should return a string private key address", function() {
        var priv = bitwsMin.wifToPriv("L3Ygumw9tv8Y7nP8y3cM164pMYugne5B9SPdf6jix1Rve4e91yTd");
        expect(priv.key).to.be.equal("bcc993177bec48f94cb0e617980a320f028f8cfa0f7a914d44ec84e017dc7cc6");
    });
